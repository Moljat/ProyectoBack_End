...
const productosFijos = [
  { id: 0, nombre: 'Mena de carbon', price: 30.0, imagen: 'imagen_carbon.png' },
  { id: 0, nombre: 'Mena de cobre', price: 50.0, imagen: 'imagen_cobre.png' },
  { id: 0, nombre: 'Mena de hierro', price: 100.0, imagen: 'imagen_hierro.png' },
  { id: 0, nombre: 'Mena de oro', price: 70.0, imagen: 'imagen_oro.png' },
  { id: 0, nombre: 'Mena de redstone', price: 80.0, imagen: 'imagen_redstone.png' },
  { id: 0, nombre: 'Mena de lapislazuli', price: 55.5, imagen: 'imagen_lapislazuli.png' },
  { id: 0, nombre: 'Mena de esmeralda', price: 200.0, imagen: 'imagen_esmeralda.png' },
  { id: 0, nombre: 'Mena de diamante', price: 500.0, imagen: 'imagen_diamante.png' },
];
